...
class ConvertSecretsSecretTypeModel(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'destination_secret_fields_ids': ([int],),  # noqa: E501
            'destination_secret_type_id': (int,),  # noqa: E501
            'secret_ids': ([int],),  # noqa: E501
            'source_secret_fields_ids': ([int],),  # noqa: E501
            'source_secret_type_id': (int,),  # noqa: E501
        }
