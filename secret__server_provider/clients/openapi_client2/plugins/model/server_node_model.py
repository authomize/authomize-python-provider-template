...
class ServerNodeModel(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'background_worker_error': (str,),  # noqa: E501
            'binary_version': (str,),  # noqa: E501
