...
class DomainSynchronizationStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'disabled_users': (int,),  # noqa: E501
            'domain_id': (int,),  # noqa: E501
            'domain_users_updated_since_last_synchronization': (int,),  # noqa: E501
            'last_log_entry': (str,),  # noqa: E501
            'new_users_created': (int,),  # noqa: E501
            'new_users_created_as_disabled': (int,),  # noqa: E501
            'users_removed_from_groups': (int,),  # noqa: E501
            'users_with_group_membership_changes': (int,),  # noqa: E501
        }
