...
class ProxyExplanationsViewModel(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'rdp_proxy_explanation': (str,),  # noqa: E501
            'ssh_proxy_explanation': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'ssh_terminal_block_list_explanation': (str,),  # noqa: E501
            'ssh_terminal_block_list_override_explanation': (str,),  # noqa: E501
            'ssh_terminal_explanation': (str,),  # noqa: E501
        }
