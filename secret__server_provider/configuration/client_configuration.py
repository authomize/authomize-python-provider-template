...
from secret__server_provider.openapi_client.plugins.api import users_api,groups_api,roles_api
from secret__server_provider.openapi_client.plugins.model.current_user_model import CurrentUserModel 
from secret__server_provider.openapi_client.plugins.model.internal_server_error_response import InternalServerErrorResponse
from secret__server_provider.openapi_client.plugins.model.authentication_failed_response import AuthenticationFailedResponse
from secret__server_provider.openapi_client.plugins.model.bad_request_response import BadRequestResponse


class SecretServerConfiguration(BaseClientConfiguration):
    configuration = Configuration(host = "https://integrations.secretservercloud.com//api")
    def __init__(self):
        super().__init__()
