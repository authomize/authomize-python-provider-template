...
class InboxTestMessageModel(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            group_id (int): The group ID to send the message.  If omitted the message is sent to the current user.. [optional]  # noqa: E501
            message (str): The actual message. [optional]  # noqa: E501
