...
class SecretDetailSecurityCheckoutUpdateModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'check_out_change_password_enabled': (UpdateFieldValueOfBoolean, none_type,),  # noqa: E501
            'check_out_enabled': (UpdateFieldValueOfBoolean, none_type,),  # noqa: E501
            'check_out_interval_minutes': (UpdateFieldValueOfOptionalInt32, none_type,),  # noqa: E501
        }
    @cached_property
    def discriminator():
        return None
